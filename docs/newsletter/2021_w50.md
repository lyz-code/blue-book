...
* New: How to write good test docstrings.
    ...
    Both [without a template](docstrings.md#without-template) and using the [Given When Then style](docstrings.md#given-when-then).[![](not-by-ai.svg){: .center}](https://notbyai.fyi)
