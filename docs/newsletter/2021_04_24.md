...
* New: Improve the periodic tasks and application metrics monitoring.
    ...
    For the notifications either use the [prometheus metrics](https://healthchecks.io/docs/configuring_prometheus/) or an [apprise](https://github.com/healthchecks/healthchecks/issues/271) compatible system.[![](not-by-ai.svg){: .center}](https://notbyai.fyi)
